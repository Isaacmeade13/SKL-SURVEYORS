    ...
    <main className="min-h-[70dvh]">
      <section className="relative w-full">
        <div className="relative h-[calc(50svh-5rem)] min-h-[300px] sm:h-[calc(65svh-5rem)] sm:min-h-[480px] w-full">
          <Image src="/images/placeholder.svg" alt="Hero background" fill priority className="object-cover" />
          ...
          <div className="grid gap-8 sm:gap-10 md:gap-12 md:grid-cols-3">
            ...
            <div 
              ...
              className={`flex flex-col h-full transform transition-all duration-1000 ease-out delay-200 ${
                visibleSections.has('about-card-1') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <div className="relative aspect-[16/11] w-full overflow-hidden rounded-lg bg-gray-100">
                ...
                <Image src="/images/placeholder.svg" alt="Questions" fill className="object-cover" />
              </div>
              <h3 className="mt-5 text-xl font-semibold text-gray-900">Have Any Questions?</h3>
              <p className="mt-3 text-gray-600 text-base sm:text-lg leading-7">
            ...
            <div 
              ...
              className={`flex flex-col h-full transform transition-all duration-1000 ease-out delay-400 ${
                visibleSections.has('about-card-2') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <div className="relative aspect-[16/11] w-full overflow-hidden rounded-lg bg-gray-100">
                <div className="absolute inset-0 border border-gray-200" />
                <Image src="/images/placeholder.svg" alt="Services" fill className="object-cover" />
              </div>
              ...
              <Link href="/services" className="mt-6 inline-flex self-start bg-[#DB5554] px-4 py-2 text-sm font-medium text-white shadow-sm hover:opacity-90 rounded-none">View Services</Link>
            </div>
            ...
            <div 
              ...
              className={`flex flex-col h-full transform transition-all duration-1000 ease-out delay-600 ${
                visibleSections.has('about-card-3') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <div className="relative aspect-[16/11] w-full overflow-hidden rounded-lg bg-gray-100">
                <div className="absolute inset-0 border border-gray-200" />
                <Image src="/images/placeholder.svg" alt="Team" fill className="object-cover" />
              </div>
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
          ...
          <div className="grid gap-6 sm:gap-8 md:gap-10 md:grid-cols-2 max-w-4xl mx-auto">
            {/* Card A */}
            <div 
              id="service-card-1"
              data-animate
              className={`rounded-xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-gray-100 transform transition-all duration-1000 ease-out delay-200 ${
            ...
            >
              <div className="mx-auto h-32 w-32 overflow-hidden rounded-full ring-1 ring-gray-200">
                <Image src="/images/placeholder.svg" alt="Roof Surveys" width={256} height={256} className="h-full w-full object-cover" />
              </div>
              <h3 className="mt-6 text-center text-xl font-semibold text-gray-900">Roof Surveys</h3>
              <p className="mt-3 text-center text-gray-600 text-base sm:text-lg leading-7">
            ...
            <div 
              id="service-card-2"
              data-animate
              className={`rounded-xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-gray-100 transform transition-all duration-1000 ease-out delay-400 ${
                visibleSections.has('service-card-2') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <div className="mx-auto h-32 w-32 overflow-hidden rounded-full ring-1 ring-gray-200">
                <Image src="/images/placeholder.svg" alt="RICS Surveys" width={256} height={256} className="h-full w-full object-cover" />
              </div>
